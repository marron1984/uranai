...
export type ThemeId = "atelier" | "neobrutal" | "editorial" | "midnight" | "twilight" | "paper" | "cream" | "forest";

export const THEMES: { id: ThemeId; label: string; swatch: string; description: string }[] = [
  { id: "atelier",   label: "アトリエ",       swatch: "#f6f2ea", description: "余白と墨・テラコッタの上品な既定" },
  { id: "editorial", label: "エディトリアル", swatch: "#fafaf7", description: "純白×漆黒の編集デザイン" },
  { id: "neobrutal", label: "ネオブルータル", swatch: "#fef9e7", description: "クリーム×漆黒×ビビッド" },
