...
// 丙火・マスター11・正義・女教皇との響き合い
// ========================================================
export const MBTI_DIVINATION_INTEGRATION: Record<MbtiType, string[]> = {
  INFJ: [
    "【丙火の太陽 × Ni】内側で受け取った未来の全体像 (Ni) を、光のように外へ放って人に届ける。INFJ の Ni が受信機なら、丙火の太陽はそれを発光させる増幅器という稀有な配置。",
    ...
    "【丙火日主 × INFJ】太陽の明るさ・温かさ (丙火) と内面の繊細さ (INFJ) のギャップが、深みのあるカリスマを生む。ASC は乙女座 (獅子座カスプ) で、外面は折り目正しく、輝きは日主の丙火が担う。",
    "【偏印 × Ni】年柱の偏印は『非凡な受信アンテナ』。常識の外から直感を掴む偏印が、INFJ の Ni (内向直観) と二重に響き合い、見えない真実を掴む力を増幅する。",
